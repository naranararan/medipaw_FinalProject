...
<head>
	...
	.favorite-button:hover {
		...
		.favorite-button.active .bi-heart-fill {
		    display: inline-block;
		}
		
		/* favorite-button에 .active 클래스가 없는 경우 빈 하트 아이콘을 보여줍니다. */
		.favorite-button:not(.active) .bi-heart {
		    display: inline-block;
		}
		  .upd-btn {
 		   background: #FFDD73;
...
<div class="review-info place-container">
	...
	<div style="display: flex; justify-content: space-between;">
		...
		<sec:authorize access="hasRole('ROLE_MEMBER')">
		        <div id="reserv-favorite" class="favorite-button">
	            <i class="bi bi-heart"></i> <!-- 빈 하트 아이콘 -->
	            <i class="bi bi-heart-fill"></i> <!-- 채운 하트 아이콘 -->
	        </div>
	  </sec:authorize>
</div>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#animalhosp-rvcnt').text(avo.rv_cnt ? ("리뷰: " + avo.rv_cnt) : "리뷰: 없음");            
